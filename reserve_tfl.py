...
class ReserveTFL():
    ...
    def reserve(self):
        ...
        while not RESERVATION_FOUND:
            ...
            self.driver.get("https://www.exploretock.com/ltdeditionsushi/search?date=%s-%s-02&size=%s&time=%s" % (RESERVATION_YEAR, month_num(RESERVATION_MONTH), RESERVATION_SIZE, "22%3A00"))
